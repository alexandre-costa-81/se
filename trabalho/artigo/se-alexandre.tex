...
\address{Centro de Desenvolvimento Tecnológico -- Universidade Federal de Pelotas
  (UFPEL)\\
  Pelotas -- RS -- Brasil
...
\begin{resumo} 
  ...
  Sistemas Evolutivos e propõe uma nova abordagem da implementação. Esse artigo
