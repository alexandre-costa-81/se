...
O presente artigo tem o objetivo de fazer uma modificação na que foi proposta
...
para fazer a reprodução sera usado a técnica de \textbf{Busca Tabu}
\textit{Tabu Search}.
...
solução para outra buscando o seu melhor vizinho.
